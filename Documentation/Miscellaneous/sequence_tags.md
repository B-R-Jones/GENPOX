...
This file tracks all available creature sequence tags, their definitions, logical triggers, and behavior within the GENPOX emulator platform (Native Android App).
...
* **Note**: Displayed as a blue shield badge.
...
* **Note**: Displayed as a pulsing green DNA helix badge.
...
* **Note**: Displayed as a mint leaf badge.
...
* **Note**: Displayed as an orange hammer badge.
...
| Tag ID | Wireframe Shape / Icon | Color Name | Color Hex | Android Component |
| :--- | :--- | :--- | :--- | :--- |
| **FAVORITE** | Five-pointed Star (Filled) | Gold / Amber | `#FFB300` | `WireframeStar(filled=true)` |
| **DEFENDER** | Heraldic Shield | Sky Blue | `#60A5FA` | `WireframeShield()` |
| **AUTO-HACKER** | Microchip / Gear | Amber | `#FBBF24` | `WireframeGear()` |
| **FULL COHERENCE** | Double Helix / DNA Wave | Cyber Green | `#00FF41` | `WireframeDna()` (Pulsing) |
| **ALPHA GENE** | Lightning Bolt | Gold | `#FFB300` | `WireframeLightning()` |
| **MODIFIED** | Four-pointed Sparkle | Purple | `#C084FC` | `WireframeSparkle()` |
| **ORIGINAL** | Concentric Target Circles | Emerald Green | `#00FF41` | `WireframeOriginal()` |
| **TRANSFER-ORIGIN** | Double Opposing Arrows | Red | `#EF4444` | `WireframeTransfer()` |
| **NATURAL** | Organic Leaf | Mint Green | `#10B981` | `WireframeNatural()` |
| **FORCED** | Anvil / Hammer | Orange | `#F59E0B` | `WireframeForced()` |
